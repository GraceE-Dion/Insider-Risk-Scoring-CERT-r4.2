...
# Step 20: Risk tier classification with lift analysis
#
...
#
# Tier thresholds aligned with ISO 27001 Annex A and NIST SP 800-53:
#   Critical: score >= 0.75
#   High:     score >= 0.50
#   Medium:   score >= 0.25
#   Low:      score <  0.25
...
#   Low tier: 922 users, 0% malicious — safely deprioritized
#
# Outputs: Risk_Tier_User_Counts.png
...
print(f"\nPopulation baseline malicious rate: "
      f"{baseline_rate:.4f} ({baseline_rate*100:.1f}%)")
...
plt.axhline(y=baseline_rate*100, color='navy', linestyle='--',
            linewidth=1.5, label=f'Baseline ({baseline_rate*100:.1f}%)')
...
plt.show()
print(f"Saved: Risk_Tier_Lift.png")
print(f"\nKey finding: Critical tier lift = {lifts[0]:.1f}x population baseline")

print("\n" + "=" * 55)
print("STATUS: Tier classification complete. Proceed to Step 21.")
print("=" * 55)
