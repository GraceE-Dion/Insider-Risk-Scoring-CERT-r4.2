...
#
# Tree-based models tend to push probabilities toward 0 or 1, making them
# poorly calibrated for risk scoring. A score of 0.7 must mean approximately
# 70% likelihood to satisfy audit requirements for personnel risk decisions
# under NIST AI RMF 1.0 and ISO 27001.
#
# Key results:
#   Uncalibrated Brier Score: 0.0038
#   Isotonic Brier Score:     0.0022 (42% improvement)
#   Platt Scaling:            0.0037 (marginal improvement)
#   Recommendation: Isotonic calibration for production scoring
#
...
print("\n" + "=" * 55)
print("STATUS: Score calibration complete. Proceed to Step 24.")
print("=" * 55)
